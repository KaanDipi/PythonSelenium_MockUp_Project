# A class that contains search customer objects for test cases.
...
# there are many tr and we are pointing all rows..tr[1] pointing the first tr
    tableColumns_xpath="//table[@id='customers-grid']//tbody/tr/td"
# there are many td and we are pointing  all columns..td[1] pointing the first td
